...
namespace Open.Domain.Location {
    ...
    public static class AddressObjectFactory {
        ...
        public static GeographicAddressObject CreateAddress(string id, string addressLine, string city,
            string regionOrState, string zipOrPostalCode, string countryId,
            DateTime? validFrom = null, DateTime? validTo = null) {
