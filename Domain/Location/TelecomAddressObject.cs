...
namespace Open.Domain.Location {
    ...
    public sealed class TelecomAddressObject : AddressObject<TelecomAddressDbRecord> {
        ...
        public IReadOnlyList<GeographicAddressObject> RegisteredInAddresses => registeredInAddresses.AsReadOnly();
        ...
        public void RegisteredInAddress(GeographicAddressObject geographicAddress) {
            ...
            if (registeredInAddresses.Find(x => x.DbRecord.ID == geographicAddress.DbRecord.ID) != null) return;
