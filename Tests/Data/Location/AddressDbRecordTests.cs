...
namespace Open.Tests.Data.Location {
    ...
    public class AddressDbRecordTests : ObjectTests<AddressDbRecord> {
        ...
        [TestMethod]
        public void CityOrAreaCodeTest() {
            testReadWriteProperty(() => obj.CityOrAreaCode, x => obj.CityOrAreaCode = x);
        }

        [TestMethod]
        public void RegionOrStateOrCountryCodeTest() {
            testReadWriteProperty(() => obj.RegionOrStateOrCountryCode, x => obj.RegionOrStateOrCountryCode = x);
        }

        [TestMethod]
        public void ZipOrPostCodeOrExtensionTest() {
            testReadWriteProperty(() => obj.ZipOrPostCodeOrExtension, x => obj.ZipOrPostCodeOrExtension = x);
        }
    }
}
