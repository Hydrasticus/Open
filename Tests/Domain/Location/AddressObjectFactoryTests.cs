...
namespace Open.Tests.Domain.Location {
    ...
    [TestClass]
    public class AddressObjectFactoryTests : BaseTests {
        ...
        private void testVariables(AddressDbRecord o, string id, string adr, DateTime vFrom, DateTime vTo,
            string city = u, string region = u, string zip = u) {
