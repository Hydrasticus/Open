...
namespace Tests.Tests {
    ...
    public class RecursionTests {
        public static string ToBackwardsUsingRecursion(string s) {
        ...
        public void ToBackwardsTest() {
            Assert.AreEqual("cba", ToBackwardsUsingRecursion("abc"));
            Assert.AreEqual("   ", ToBackwardsUsingRecursion("   "));
            Assert.AreEqual("", ToBackwardsUsingRecursion(""));
            Assert.AreEqual(string.Empty, ToBackwardsUsingRecursion(null));
        }
    }
}
